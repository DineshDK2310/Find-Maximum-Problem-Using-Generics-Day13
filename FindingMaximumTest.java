...
public class FindingMaximumTest <E extends Comparable<E>> {
	...
	public FindingMaximumTest(E x, E y, E z) {
		this.firstValue = x;
		this.secondValue = y;
		this.thirdValue = z;
	}
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
			{
				...
				System.out.println("Maximum  is : " + new FindingMaximumTest(first, second, third).maximum());
